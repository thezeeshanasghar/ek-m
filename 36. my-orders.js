            ...
            success: function (result) {
                ...
                $.each(result, function (key, order) {
                    ...
                    if (order.OrderStatus == 0 || order.OrderStatus == 1 || order.OrderStatus == 5 || order.OrderStatus == 6 || order.OrderStatus == 7 ) {
                        ...
                        html += ' <div class="order-action"><a onclick = "loadOrderDetails('+order.Id+');">Details</a><br><a class="reorder" onclick = "loadOrderDetails('+order.Id+');">Reorder</a></div></div></div></li>';
                    }
